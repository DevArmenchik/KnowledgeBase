...
`$removeparam` söz dizimi, [CoreLibs](https://adguard.com/en/blog/introducing-corelibs.html) v1.7 ve AdGuard Tarayıcı Uzantısı v3.6'dan başlayarak desteklenir.
